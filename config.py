...
def set_args():
    ...
    parser.add_argument('--pretrained_model_path', default='Langboat/mengzi-bert-base', type=str, help='预训练模型的路径')
    ...
    parser.add_argument('--train_batch_size', default=30, type=int, help='训练批次大小')
